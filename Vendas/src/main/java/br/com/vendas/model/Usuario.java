...
public class Usuario implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6488114847052587822L;
	@Id
	@GeneratedValue
	...
	public Usuario( String nome, String email, String login,
			String senha, Date nascimento, String celular, String idioma,
	...
	public String toString() {
		return "Usuario [codigo=" + codigo + ", nome=" + nome + ", email="
				...
				+ ", nascimento=" + nascimento + ", celular=" + celular
				+ ", idioma=" + idioma + ", ativo=" + ativo + ", permissao="
				+ permissao + "]";
	}
